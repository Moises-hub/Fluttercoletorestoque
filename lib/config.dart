...
class _ConfiguracaoState extends State<Configuracao> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Configuração', style: TextStyle(fontSize: 25, color: Colors.white),),
          centerTitle: true,
        ),
        body:
                        ...
                        child: Center(
                          ...
                          TextFormField(
                            ...
                            onChanged: (val) =>
                                ...
                                initiatePort(val),
                            decoration: InputDecoration(
                              labelText: 'Digite a Porta de Acesso ex. 311',
                              labelStyle: const TextStyle(color: Colors.blueGrey, fontSize: 15),
                              errorStyle: const TextStyle(color: Colors.redAccent),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(23),
  ...
  showAlertDialog(BuildContext context) {
    AlertDialog alert = AlertDialog(
      content: Text("Salvo com Sucesso!, Atualize a pagina para as Alteração fazerem Sucesso!"),
      actions: [
        ElevatedButton(
